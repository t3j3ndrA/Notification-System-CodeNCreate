      ...
      >
        <div className="md:p-4 py-2 flex flex-row md:flex-col">
          {theme === "light" ? (
            ...
            <img
              src="../images/insta-dark.png"
              className="md:w-3/4 hidden md:block"
            />
          )}
        ...
        <div className="p-4 w-full md:block hidden">
          <Link
            to={"/"}
            className="bg-blue-500 hover:bg-blue-600 flex justify-center duration-200 items-center text-white py-2 px-4 rounded-lg font-bold w-full dark:bg-[#262626] dark:hover:bg-[#2d3436]"
          >
            Logout
